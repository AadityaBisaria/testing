...
1. **Scaffold first. Never hand-write boilerplate
(base) PS C:\Users\Aaditya Bisaria\test_pilot> pipecat init
Project directory [pipecat-bot]: 
✔ Wrote pipecat-bot\AGENTS.md
✔ Wrote pipecat-bot\CLAUDE.md
? How do you want to build? Build with a coding agent (recommended)
✔ Wrote pipecat-bot\GETTING_STARTED.md

Your project is ready.

Read GETTING_STARTED.md for how to prompt your agent, then open a coding session in pipecat-bot to start building.
(base) PS C:\Users\Aaditya Bisaria\test_pilot> .** Start every new app from the Pipecat CLI scaffold (§1) — it generates a *runnable* bot (services + pipeline already wired), not a bare skeleton. Modify what it generates; don't rebuild it or invent your own structure.
